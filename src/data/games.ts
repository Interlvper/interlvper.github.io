...
export const GAMES: Game[] = [
  {
    ...
    title: 'APOAXIA',
    year: 2026,
    description: 'An extraction-based hardcore tactical shooter built in <strong>Unreal Engine 5</strong> with <strong>dedicated server multiplayer</strong>. Deploy to raids and scavenge better equipment, unlock new locations, and defeat the boss.',
    ...
    imageAlt: 'APOAXIA — Unreal Engine 5 extraction tactical shooter by Tyler Myles',
    ...
    systems: [
      ...
      { title: 'Ballistics System', desc: 'A data-oriented, server-authoritative projectile simulation system that allows for thousands of replicated projectiles at once. Built with Unreal\'s network prediction framework.' },
      ...
      { title: 'Inventory System', desc: 'A complex grid inventory system similar to that of Diablo, Escape From Tarkov, and System Shock 2. Server-authoritative with client-side prediction and rollback. Utilizes a flat array per inventory wrapped within a FFastArraySerializer for efficient netcode replication.' },
      ...
      { title: 'Loot Generation', desc: 'A robust loot generation system complete with custom Slate UI editor tooling to make creating pools and tables easier. Developers can simulate tables, view drop percentages, and apply tables modularly to containers in the game.' },
  ...
  },
  {
    ...
    title: 'LIMINAL',
    year: 2024,
    description: 'A challenging first-person psychological horror and survival game built in <strong>Unreal Engine 5</strong> featuring procedural world generation. You are faced with an unfamiliar environment of which you know nothing.',
    image: 'https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2160760/header.jpg',
    fallbackImage: null,
    imageAlt: 'LIMINAL — Unreal Engine 5 procedural horror game by Tyler Myles, available on Steam',
    ...
    systems: [
      { title: 'Procedural World Generation', desc: 'A system that procedurally generates the world around actors which have an invoker component. The system is data-driven, allowing custom biomes to be defined within a collection of data assets for infinite, non-repeating level layouts.' },
